...
@Getter
@Setter
public class BackfillRequestHeader extends AbstractOAuth10aRequestHeader {
    ...
    public BackfillRequestHeader(String serverUrl,
                                                 String oauthConsumerKey,
                                                 String oauthConsumerSecret,
                                                 String oauthToken,
                                                 String oauthTokenSecret,
                                                 String oauthVerifier,
                                                 String summaryStartTimeInSeconds,
                                                 String summaryEndTimeInSeconds) {
        ...
        this.summaryStartTimeInSeconds = summaryStartTimeInSeconds;
        this.summaryEndTimeInSeconds = summaryEndTimeInSeconds;
    }
    ...
    public String getRequestBackFillHeader() {
        ...
        sb.append("OAuth ")
                ...
                .append(OAuth10aConstants.OAUTH_NONCE).append("=\"").append(this.oauthNonce).append("\", ")
                .append(OAuth10aConstants.OAUTH_VERSION).append("=\"").append(this.oauthVersion).append("\", ")
                .append(OAuth10aConstants.SUMMARY_START_TIME_IN_SECONDS).append("=\"").append(this.summaryStartTimeInSeconds).append("\", ")
                .append(OAuth10aConstants.SUMMARY_END_TIME_IN_SECONDS).append("=\"").append(this.summaryEndTimeInSeconds).append("\", ")
                .append(OAuth10aConstants.OAUTH_SIGNATURE).append("=\"").append(getPercentEncoded(this.oauthSignature)).append("\"");
        return sb.toString();
    }
    ...
    public Map<String, String> getRequestHeaderMap() {
        ...
        headerMap.put(OAuth10aConstants.SUMMARY_START_TIME_IN_SECONDS, this.summaryStartTimeInSeconds);
        headerMap.put(OAuth10aConstants.SUMMARY_END_TIME_IN_SECONDS, this.summaryEndTimeInSeconds);
